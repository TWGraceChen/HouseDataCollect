...
# waste
data = waste.Transform(path+'/waste.csv')
table = "waste"
bo.load(db,table,schema[table],data) 


# nightmarket
data = nightmarket.Transform(path+'/nightmarket.csv')
table = "nightmarket"
bo.load(db,table,schema[table],data) 


# powerplant
data = powerplant.Transform(path+'/powerplant.csv')
table = "powerplant"
bo.load(db,table,schema[table],data) 


# lpg
data = lpg.Transform(path+'/lpg.csv')
table = "lpg"
bo.load(db,table,schema[table],data) 